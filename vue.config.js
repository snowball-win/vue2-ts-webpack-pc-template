...
const name = '数字化供应链' // TODO: get this variable from setting.ts
// console.log('10p', process)
  ...
  devServer: {
    ...
    proxy: {
      ...
      [process.env.VUE_APP_BASE_API]: {
        // target: `http://127.0.0.1:${mockServerPort}/mock-api/v1`, //本地接口
        // target: `https://mt.heng-tai.com.cn`, // 公司接口使用变量
        target: 'http://www.zkrxlink.com/', // 公司接口使用变量
        // target: 'http://47.118.29.40/', // 公司接口使用变量
      ...
      '/mmbiz_png': {
        // target: `http://127.0.0.1:${mockServerPort}/mock-api/v1`, //本地接口
        // target: `https://mt.heng-tai.com.cn`, // 公司接口使用变量
        target: 'http://mmbiz.qpic.cn', // 公司接口使用变量
        // target: 'http://47.118.29.40/', // 公司接口使用变量
        changeOrigin: true // needed for virtual hosted sites
      }
    }
