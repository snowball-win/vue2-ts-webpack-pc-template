...
import organizationRouter from './modules/organization' // 组织管理
import orderRouter from './modules/order' // 订单管理
import goodsRouter from './modules/goods' // 商品管理
import dashboardRouter from './modules/dashboard' // 商品管理
import wecharRouter from './modules/wechat'
...
/*
  ...
  meta: {
    ...
    title: 'route.title'               the name showed in subMenu and breadcrumb (recommend set)
...
export const constantRoutes: RouteConfig[] = [
  ...
  //       name: 'Documentation',
  //       meta: { title: 'route.documentation', icon: 'documentation', affix: true }
  //     }
  //   ]
  // },
  // {
