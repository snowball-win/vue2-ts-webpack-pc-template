export default {
  route: {
    ...
    userManager: '用户管理',
    userList: '用户查询',
    userRelationCompany: '企业信息',
    usercreate: '创建用户',
    useredit: '用户编辑',
    organizationManager: '机构管理',
    organizationStaffList: '员工管理',
    organizationCreate: '新建机构',
    organizationEdit: '编辑机构',
    organizationStaff: '员工管理',
    organizationStaffCreate: '员工管理-创建',
    organizationStaffEdit: '员工管理-编辑',
    organizationList: '机构查询',
    orderManager: '订单管理',
    orderCreate: '新建订单',
    orderDetail: '订单详情',
    'confirm-order': '订单提交',
    orderCart: '购物车',
    purchaseOrderList: '进货订单',
    saleOrderList: '进货销售',
    orderStaff: '订单管理list',
    goodsManager: '商品管理',
    goodsList: '上架管理',
